...
namespace OpenSource.UPnP.AV.CdsMetadata
{
	...
	/// <summary>
	/// This struct wraps the standard long value type
	/// with an <see cref="IValueType"/> interface.
	/// </summary>
	[Serializable()]
	public struct _Long : IValueType
	{
		/// <summary>
		...
		/// If the object is another _Long value, it
