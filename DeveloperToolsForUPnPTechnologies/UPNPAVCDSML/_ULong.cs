...
namespace OpenSource.UPnP.AV.CdsMetadata
{
	...
	/// <summary>
	/// This struct wraps the standard unsigned long value type
	/// with an <see cref="IValueType"/> interface.
	/// </summary>
	[Serializable()]
	public struct _ULong : IValueType
	{
		/// <summary>
		/// Returns the unsigned ulong value.
		...
		/// If the object is another _ULong value, it
		...
		public int CompareTo(object obj)
		{
			...
			if (type == typeof(_ULong))
			{
				_ULong ui = (_ULong) obj;
