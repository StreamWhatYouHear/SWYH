...
namespace OpenSource.UPnP.AV.CdsMetadata
{
	...
	/// <summary>
	/// This struct wraps the standard UInt32 value type
	/// with an <see cref="IValueType"/> interface.
	/// </summary>
	[Serializable()]
	public struct _UInt : IValueType
	{
		/// <summary>
		...
		/// If the object is another _UInt value, it
