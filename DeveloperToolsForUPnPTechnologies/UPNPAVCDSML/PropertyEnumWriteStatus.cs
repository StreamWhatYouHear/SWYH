...
namespace OpenSource.UPnP.AV.CdsMetadata
{
	...
	/// simple 
	/// <see cref="EnumWriteStatus"/>
	/// values without any attributes.
	/// </summary>
	[Serializable()]
	public sealed class PropertyEnumWriteStatus : ICdsElement, IToXmlData, IDeserializationCallback
	{
		/// <summary>
		...
		public PropertyEnumWriteStatus(XmlElement element)
		{
			this.m_value = (EnumWriteStatus) Enum.Parse(typeof(EnumWriteStatus), element.InnerText, true);
		...
		public PropertyEnumWriteStatus(XmlReader reader)
		{

			this.m_value = (EnumWriteStatus) Enum.Parse(typeof(EnumWriteStatus), reader.Value, true);
		...
		/// </summary>
		public EnumWriteStatus _Value { get { return this.m_value; } }
		internal EnumWriteStatus m_value;
